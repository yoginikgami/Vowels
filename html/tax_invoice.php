...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["id"])) {
    ...
    $sql = "UPDATE temps_condi_tax_invoice SET optional = '$optional' WHERE id = '$id'";
...
$sql = "SELECT id, tems_cond_name, optional FROM temps_condi_tax_invoice  ORDER BY `position` ASC";
...
<body>
    ...
    <div class="container-fluid">
        <div style="text-align:center; display:flex;">
            ...
            <div class="showRecordsDiv" style="margin-left:30%; width:60%;">
                <td align="center" style="margin-left:50%;">
                    <h2 class="pageHeading" id="pageHeading">Tax Invoice Transaction</h2>
                </td>


            </div>
            <div style="width:30%; margin-left:15%;">
                <td><b>Financial Year</b><br>
                    <p id="financialYear" class="font-weight-bold p-2" style="font-weight: bold;"></p>
                </td>
            </div>
        ...
        <div class="row border justify-content-center" id="after-heading">
            ...
            <form method="post" enctype="multipart/form-data" class="col-lg-12 col-sm-12 d-none" id="addNew_TaxInvoice">
                    ...
                    <div class="form-group d-block col-md-3">
                        ...
                        <select class="form-control w-100" name="procure_type" id="procure_type">
                            ...
                            <option value="Service" <?php if (isset($_POST['editGSTFeesbtn'])) {
                                                        if ($edit_bill_type == "CGST & SGST") echo 'selected';
                                                    } ?>>Service</option>
                            <option value="Goods" <?php if (isset($_POST['editGSTFeesbtn'])) {
                                                        if ($edit_bill_type == "IGST") echo 'selected';
                                                    } ?>>Goods</option>
                        </select>
                    </div>
                    <?php
				...
				<div class="form-inline"> -->
                    <div class="form-group d-block col-md-3">
                        ...
                        <select class="form-control w-100" name="gst_type" id="gst_type">
                            <option value="CGST & SGST" <?php if (isset($_POST['editGSTFeesbtn'])) {
                                                            if ($edit_gst_type == "CGST & SGST") echo 'selected';
                                                        } ?>>CGST & SGST</option>
                            <option value="IGST" <?php if (isset($_POST['editGSTFeesbtn'])) {
                                                        if ($edit_gst_type == "IGST") echo 'selected';
                                                    } ?>>IGST</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group d-block col-md-3">
                        <label class="float-left p-2" for="gst_type">Teams & Conditions <span style="color: red;"
                                class="pl-1">*</span></label>
                        <di class="dropdown">
                        ...
                        <form id="termsForm">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <label>Save</label><br>
                                        <button type="button" class="btn btn-vowel" id="add_company_name_drop_btn">Add</button>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add_company_name_drop_btn').click(function() {
                ...
                var position_number = $('#position_number_txt_drop').val(); // Keep it as raw number input
                var optionalValue = $('#company_optional_txt_drop').is(':checked') ? "1" : "0"; // 1 if checked, 0 if unchecked

                // alert("Position: " + position_number);
                // alert("Service: " + serviceValue);
                // alert("Optional: " + optionalValue);
                ...
                if (serviceValue !== "" && !serviceValue.includes("(") && !serviceValue.includes(")")) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            optional_value: optionalValue // Passing checkbox value
                        },
                        dataType: "text",
                        success: function(data) {
                            if (data == "service_ok") {
                                $('#Service-status_company').html("Position Already Available").css({
                                    'color': 'green'
                                });
