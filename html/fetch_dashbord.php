                ...
                <div class="col-md-6" >
                    ...
                    <script>
                        ...
                        function updateChart(data) {
                            ...
                            const salesData = labels.map(label => parseFloat(data[label]) || 0);
                        ...
                        // Initially hide the salesChart and show salesChart1
                        document.getElementById('salesChart').style.display = 'none';
                        document.getElementById('salesChart1').style.display = 'block';
                        document.getElementById('btnSearch').style.display = 'none';
                ...
                <div class="col-md-6">
                    ...
                    <script>
                        ...
                        $('#client').on('change', function () {
                            ...
                            if (clientId) {
                                $.ajax({
                                    url: 'html/fetch_client_details.php', // Server-side script for fetching details
                                    type: 'POST',
                                    data: { id: clientId },
                                    dataType: 'json',
